...
<head>
	...
	<title>Proyecciones de Tarija</title>
...
<body>
	...
	<img style="padding: 0px;margin: 0px;" class="resp" id="resp" src="logovirus.jpg" onclick="location.href='index.html';">
	...
	<div class="container my-Container">
		<div class="row my-Row">
			<div class="col my-Col">
				<p style="font-size: 25px;text-align: center;"><strong>PROYECCIONES DE TARIJA</strong></p>
				<p>En esta página se utiliza el modelo SIR para realizar las proyecciones de Tarija.</p>
				...
				<p>Poblaci&oacute;n estimada: 583330.</p>
	...
	<div class="container my-Container">
		<div class="row my-Row">
			<div class="col my-Col">
				<h5><strong>1.</strong> Tasa de transmisión: 0.648843e-6</h5>	
			</div>
		</div>
		...
		<div class="row my-Row">
			<div class="col my-Col">
				<h5><strong>2.</strong> Tasa de transmisión: 0.673608e-6</h5>	
			</div>
		</div>
		...
		<div class="row my-Row">
			<div class="col my-Col">
				<h5><strong>3.</strong> Tasa de transmisión: 0.698373e-6</h5>	
			</div>
		</div>
		...
		<div class="row my-Row">
			<div class="col my-Col">
				<h5><strong>4.</strong> Tasa de transmisión: 0.723138e-6</h5>	
			</div>
		</div>
		...
		<div class="row my-Row">
			<div class="col my-Col">
				<h5><strong>5.</strong> Tasa de transmisión: 0.747903e-6</h5>	
			</div>
		</div>
		...
		<div class="row my-Row">
			<div class="col my-Col">
				<h5><strong>6.</strong> Tasa de transmisión: 0.772668e-6</h5>	
			</div>
		</div>
		...
		<div class="row my-Row">
			<div class="col my-Col">
				<h5><strong>7.</strong> Tasa de transmisión: 0.797433e-6</h5>	
			</div>
		</div>
		...
		<div class="row my-Row">
			<div class="col my-Col">
				<h5><strong>8.</strong> Tasa de transmisión: 0.822198e-6</h5>
			</div>
		</div>
	...
	<script type="text/javascript">
		async function graficar(){
			SIR_infectados = [];
			SIR_infectados = await $.get("SIR_Infectados10.txt", function(data) { 
				return data;
			});
			...
			SIR_sospechosos = [];
			SIR_sospechosos = await $.get("SIR_Sospechosos10.txt", function(data) { 
				return data;
			});
			...
			SIR_recuperados = [];
			SIR_recuperados = await $.get("SIR_Recuperados10.txt", function(data) { 
				return data;
			});
			...
			//BETA = 0.11
			SIR_infectados11 = [];
			SIR_infectados11 = await $.get("SIR_Infectados11.txt", function(data) { 
				return data;
			});
			...
			SIR_sospechosos_11 = [];
			SIR_sospechosos_11 = await $.get("SIR_Sospechosos11.txt", function(data) { 
				return data;
			});
			...
			SIR_recuperados_11 = [];
			SIR_recuperados_11 = await $.get("SIR_Recuperados11.txt", function(data) { 
				return data;
			});
			...
			//BETA = 0.12
			SIR_infectados12 = [];
			SIR_infectados12 = await $.get("SIR_Infectados12.txt", function(data) { 
				return data;
			});
			...
			SIR_sospechosos_12 = [];
			SIR_sospechosos_12 = await $.get("SIR_Sospechosos12.txt", function(data) { 
				return data;
			});
			...
			SIR_recuperados_12 = [];
			SIR_recuperados_12 = await $.get("SIR_Recuperados12.txt", function(data) { 
				return data;
			});
			...
			//BETA = 0.13
			SIR_infectados13 = [];
			SIR_infectados13 = await $.get("SIR_Infectados13.txt", function(data) { 
				return data;
			});
			...
			SIR_sospechosos_13 = [];
			SIR_sospechosos_13 = await $.get("SIR_Sospechosos13.txt", function(data) { 
				return data;
			});
			...
			SIR_recuperados_13 = [];
			SIR_recuperados_13 = await $.get("SIR_Recuperados13.txt", function(data) { 
				return data;
			});
			...
			//BETA = 0.14
			SIR_infectados14 = [];
			SIR_infectados14 = await $.get("SIR_Infectados14.txt", function(data) { 
				return data;
			});
			...
			SIR_sospechosos_14 = [];
			SIR_sospechosos_14 = await $.get("SIR_Sospechosos14.txt", function(data) { 
				return data;
			});
			...
			SIR_recuperados_14 = [];
			SIR_recuperados_14 = await $.get("SIR_Recuperados14.txt", function(data) { 
				return data;
			});
			...
			//BETA = 0.15
			SIR_infectados15 = [];
			SIR_infectados15 = await $.get("SIR_Infectados15.txt", function(data) { 
				return data;
			});
			...
			SIR_sospechosos_15 = [];
			SIR_sospechosos_15 = await $.get("SIR_Sospechosos15.txt", function(data) { 
				return data;
			});
			...
			SIR_recuperados_15 = [];
			SIR_recuperados_15 = await $.get("SIR_Recuperados15.txt", function(data) { 
				return data;
			});
			...
			//BETA = 0.16
			SIR_infectados16 = [];
			SIR_infectados16 = await $.get("SIR_Infectados16.txt", function(data) { 
				return data;
			});
			...
			SIR_sospechosos_16 = [];
			SIR_sospechosos_16 = await $.get("SIR_Sospechosos16.txt", function(data) { 
				return data;
			});
			...
			SIR_recuperados_16 = [];
			SIR_recuperados_16 = await $.get("SIR_Recuperados16.txt", function(data) { 
				return data;
			});
			...
			//BETA = 0.17
			SIR_infectados17 = [];
			SIR_infectados17 = await $.get("SIR_Infectados17.txt", function(data) { 
				return data;
			});
			...
			SIR_sospechosos_17 = [];
			SIR_sospechosos_17 = await $.get("SIR_Sospechosos17.txt", function(data) { 
				return data;
			});
			...
			SIR_recuperados_17 = [];
			SIR_recuperados_17 = await $.get("SIR_Recuperados17.txt", function(data) { 
				return data;
			});
			...
			activosActualTarija = 0;
			await $.getJSON("DatosBolivia.json").then(data => {
				const countries = data;
				countries.forEach(country => {
					if(country.countryregion == "Tarija"){
						activosActualTarija = country.confirmed - country.deaths - country.recovered;
					}
				});
			});
			...
			for (var ix = 0; ix < SIR_puntos.length; ix++) {
				if(SIR_puntos[ix]["x"].getFullYear()==fechaActual.getFullYear() && SIR_puntos[ix]["x"].getMonth()==fechaActual.getMonth() && SIR_puntos[ix]["x"].getDate()==fechaActual.getDate()){
					if(Math.abs(SIR_puntos[ix]["y"] - activosActualTarija) < 0.20 * activosActualTarija){
						$("#aproxReal").html("La gráfica 1 es la mas aproximada a la situación actual.");
						break;
					}
					if(Math.abs(SIR_puntos_11[ix]["y"] - activosActualTarija) < 0.20 * activosActualTarija){
						$("#aproxReal").html("La gráfica 2 es la mas aproximada a la situación actual.");
						break;
					}
					if(Math.abs(SIR_puntos_12[ix]["y"] - activosActualTarija) < 0.20 * activosActualTarija){
						$("#aproxReal").html("La gráfica 3 es la mas aproximada a la situación actual.");
						break;
					}
					if(Math.abs(SIR_puntos_13[ix]["y"] - activosActualTarija) < 0.20 * activosActualTarija){
						$("#aproxReal").html("La gráfica 4 es la mas aproximada a la situación actual.");
						break;
					}
					if(Math.abs(SIR_puntos_14[ix]["y"] - activosActualTarija) < 0.20 * activosActualTarija){
						$("#aproxReal").html("La gráfica 5 es la mas aproximada a la situación actual.");
						break;
					}
					if(Math.abs(SIR_puntos_15[ix]["y"] - activosActualTarija) < 0.20 * activosActualTarija){
						$("#aproxReal").html("La gráfica 6 es la mas aproximada a la situación actual.");
						break;
					}
					if(Math.abs(SIR_puntos_16[ix]["y"] - activosActualTarija) < 0.20 * activosActualTarija){
						$("#aproxReal").html("La gráfica 7 es la mas aproximada a la situación actual.");
						break;
					}
					if(Math.abs(SIR_puntos_17[ix]["y"] - activosActualTarija) < 0.20 * activosActualTarija){
